...
public class ContactsFragment extends Fragment {
                    ...
                    UsersRef.child(userIDs).addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if (dataSnapshot.hasChild("image")){
                                String user = dataSnapshot.child("image").getValue().toString();
                                String name = dataSnapshot.child("name").getValue().toString();
                                String statues = dataSnapshot.child("statues").getValue().toString();

                                contactsViewHolder.userName.setText(name);
                                contactsViewHolder.userStatus.setText(statues);
                                Picasso.get().load(user).placeholder(R.drawable.profile_image).into(contactsViewHolder.profileImage);
                            }
                            else {
                                String name = dataSnapshot.child("name").getValue().toString();
                                String statues = dataSnapshot.child("statues").getValue().toString();
    ...
    public static class ContactsViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public ContactsViewHolder(@NonNull View itemView)
        {
            ...
            userStatus = itemView.findViewById(R.id.user_statues);
            profileImage = itemView.findViewById(R.id.users_profile_images);
            onlineIcon = itemView.findViewById(R.id.user_online_statues);
        }
    }
}
